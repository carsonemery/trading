...
Responsible for:
- connection, disconnection, and reconnection to the TWS Gateway
- declares ALL EWrapper methods
- translates raw callbacks into clean internal events
- forward those events to proper destinations
...
class TradingClient : public DefaultEWrapper
{
public:
    TradingClient();
    ~TradingClient();
    ...
    // event methods optionally implemented
public:
...
private:
    ...
    // bool m_extraAuth; don't need this right now, hard coded to false in the constructor
};